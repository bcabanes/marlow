...
export const createLazyGitHubPort = (
  ...
  createPullRequestReviewComment: (input) =>
    resolve().then((p) => p.createPullRequestReviewComment(input)),
  createPullRequestReviewCommentReply: (input) =>
    resolve().then((p) => p.createPullRequestReviewCommentReply(input)),
  listPullRequestReviews: (input) =>
    resolve().then((p) => p.listPullRequestReviews(input)),
  createPullRequestReview: (input) =>
    resolve().then((p) => p.createPullRequestReview(input)),
  listPullRequestStacks: (input) =>
    resolve().then((p) => p.listPullRequestStacks(input)),
  getPullRequestStack: (input) =>
    resolve().then((p) => p.getPullRequestStack(input)),
  createPullRequestStack: (input) =>
    resolve().then((p) => p.createPullRequestStack(input)),
  addPullRequestsToStack: (input) =>
    resolve().then((p) => p.addPullRequestsToStack(input)),
  unstackPullRequests: (input) =>
    resolve().then((p) => p.unstackPullRequests(input)),
  mergePullRequestAsync: (input) =>
    resolve().then((p) => p.mergePullRequestAsync(input)),
  getPullRequestMergeResult: (input) =>
    resolve().then((p) => p.getPullRequestMergeResult(input)),
