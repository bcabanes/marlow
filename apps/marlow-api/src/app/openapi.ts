...
const endpoints: readonly Endpoint[] = [
  ...
  { method: 'get', path: '/repos/{owner}/{repo}/commits', tag: 'commits', operationId: 'listCommits', summary: 'List commits', returns: 'CommitListItem[]', params: [...repoParams, ...commitsQuery] },
  ...
  { method: 'get', path: '/repos/{owner}/{repo}/issues', tag: 'issues', operationId: 'listIssues', summary: 'List issues', returns: 'IssueSummary[]', params: [...repoParams, stateQuery, ...pagination] },
  ...
  { method: 'get', path: '/repos/{owner}/{repo}/pulls', tag: 'pulls', operationId: 'listPullRequests', summary: 'List pull requests', returns: 'PullRequestSummary[]', params: [...repoParams, stateQuery, ...pagination] },
