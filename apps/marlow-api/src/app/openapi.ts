...
export const endpoints: readonly Endpoint[] = [
  ...
  { method: 'get', path: '/repos/{owner}/{repo}/pulls/{pullNumber}/reviews', tag: 'pulls', operationId: 'listPullRequestReviews', summary: 'List the reviews (verdicts) on a pull request', returns: 'PullRequestReview[]', params: [...pullParams, ...pagination] },
